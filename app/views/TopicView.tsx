...
const TOPIC_CONFIGS: Record<string, { title: string; subtitle: string; icon: string; bannerGradient: string; tags: string[] }> = {
  'topic-beginner': {
    ...
    subtitle: 'Educational guides, risk management strategies, and starter market insights from CoinGecko.',
    icon: '🌱',
...
export const TopicView: React.FC<TopicViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Hero Header Banner */}
      <div className={`bg-gradient-to-r ${config.bannerGradient} p-6 sm:p-8 rounded-3xl border border-[#2E2E2E] shadow-xl relative overflow-hidden`}>
      ...
      <div className="bg-[#212121] border border-[#2E2E2E] rounded-3xl p-4 shadow-lg">
        <div className="text-[11px] font-extrabold text-gray-400 uppercase tracking-wider mb-3 px-1 flex items-center justify-between">
          ...
          <span className="text-[#17C99E] font-mono">Live CoinGecko Prices</span>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {news.map((item) => (
              <div
                key={item.id}
                className="bg-[#212121] border border-[#2E2E2E] hover:border-[#17C99E]/40 rounded-3xl overflow-hidden shadow-xl flex flex-col justify-between group transition-all"
              >
                {/* News Cover Image */}
                {item.image && (
                  <div className="h-44 w-full overflow-hidden relative">
                    ...
                    />
                    <div className="absolute top-3 left-3 bg-[#161616]/80 backdrop-blur-md text-[#17C99E] text-[10px] font-bold px-2.5 py-1 rounded-full border border-[#17C99E]/30 font-mono">
                      {item.topic}
                    </div>
                  </div>
                )}
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-[11px] text-gray-400 font-medium">
                      <span className="text-[#17C99E] font-bold">{item.source}</span>
                    ...
                    <h3 className="text-base font-extrabold text-white group-hover:text-[#17C99E] transition-colors leading-snug">
                      {item.title}
                    </h3>
                  ...
                  <div className="pt-3 border-t border-[#2E2E2E] flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2 ml-auto">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center space-x-1 bg-[#17C99E] hover:bg-[#14B8A6] text-black font-extrabold text-xs px-3 py-2 rounded-xl transition-all shadow-sm"
                      >
          ...
          <div className="py-12 bg-[#212121] border border-[#2E2E2E] rounded-3xl text-center text-gray-400">

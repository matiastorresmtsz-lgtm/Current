...
import { X, Eye, EyeOff, Lock, Globe, Shield } from 'lucide-react';
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className={`w-11 h-11 rounded-2xl flex items-center justify-center mb-3 ${
                ...
                <Globe className={`w-5 h-5 ${selected ? 'text-emerald-400' : 'text-gray-400'}`} />
              </div>
            ...
            >
              <div className={`w-11 h-11 rounded-2xl flex items-center justify-center mb-3 ${
                ...
                <Lock className={`w-5 h-5 ${!selected ? 'text-[#8B5CF6]' : 'text-gray-400'}`} />
              </div>
          ...
          <div className="flex items-start space-x-2.5 bg-[#161616] border border-[#2E2E2E] rounded-xl px-4 py-3">
            ...
            <p className="text-[11px] text-gray-400 leading-relaxed">
              {selected
                ? 'Your portfolio value, holdings, and returns are visible to other Rouge users and the public shareable link.'
          ...
          >
            {saved ? (
              ...
              <>
                {selected ? <Globe className="w-4 h-4" /> : <EyeOff className="w-4 h-4" />}

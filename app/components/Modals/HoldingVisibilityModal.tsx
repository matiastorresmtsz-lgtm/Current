...
import { Check, Eye, Globe2, LockKeyhole, ShieldCheck, X } from 'lucide-react';
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className={`w-11 h-11 rounded-2xl flex items-center justify-center mb-3 ${
                ...
                <Globe2 className={`w-5 h-5 ${selected ? 'text-emerald-400' : 'text-gray-400'}`} />
              </div>
            ...
            >
              <div className={`w-11 h-11 rounded-2xl flex items-center justify-center mb-3 ${
                ...
                <LockKeyhole className={`w-5 h-5 ${!selected ? 'text-[#8B5CF6]' : 'text-gray-400'}`} />
              </div>
          ...
          >
            {saved ? (
              ...
              <>
                {selected ? <Globe2 className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
